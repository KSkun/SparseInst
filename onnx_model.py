...
if __name__ == '__main__':
    ...
    # ort_sess = ort.InferenceSession('sparse_inst.onnx',
    #                                 providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
    # ort_sess = ort.InferenceSession('sparse_inst_opt.onnx',
    #                                 providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
    ort_sess = ort.InferenceSession('sparse_inst_quant.onnx',
                                    providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
    ...
    # cv2.imwrite('hust1-result-opt.jpg', output_image)
    cv2.imwrite('hust1-result-quant.jpg', output_image)
